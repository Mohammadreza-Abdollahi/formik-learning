            ...
            <div className="my-form py-10 rounded-lg">
                ...
                <form onSubmit={formik.handleSubmit} className='px-12'>
                    <div className='mb-6'>
                        ...
                        <input {...formik.getFieldProps('name')} type="text" className="mt-2 transition duration-200 block m-auto w-full rounded-md outline-none px-3 py-3 text-slate-800 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-purple-500 text-xl" placeholder="نام خود را وارد کنید..."></input>
                    ...
                    <div className='mb-6'>
                        ...
                        <input {...formik.getFieldProps('email')} id='email' type="text" className="mt-2 transition duration-200 block m-auto w-full rounded-md outline-none px-3 py-3 text-slate-800 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-purple-500 text-xl" placeholder="ایمیل خود را وارد کنید..."></input>
                    ...
                    <div className='mb-6'>
                        ...
                        <input {...formik.getFieldProps('password')} id='password' type="password" className="mt-2 transition duration-200 block m-auto w-full rounded-md outline-none px-3 py-3 text-slate-800 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-purple-500 text-xl" placeholder="رمزعبور خود را وارد کنید..."></input>
